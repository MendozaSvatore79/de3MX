...
function Copy() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center p-[10px] relative shrink-0" data-name="Copy">
      <div className="font-['Inter:Bold',sans-serif] font-bold leading-[80px] not-italic relative shrink-0 text-[#2b2b2c] text-[62px] text-nowrap whitespace-pre">
        <p className="mb-0" style={{ fontSize: '62px', lineHeight: '80px', fontWeight: 'bold' }}>
          <span className="text-[#00da6b]">Our mission</span>
          <span>{` is to `}</span>
        </p>
        <p className="mb-0" style={{ fontSize: '62px', lineHeight: '80px', fontWeight: 'bold' }}>make your brand</p>
        <p style={{ fontSize: '62px', lineHeight: '80px', fontWeight: 'bold' }}>grow.</p>
      </div>
    </div>
  );
}
...
function Vector() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[57px] py-[84px] relative shrink-0 w-[629px]" data-name="Vector">
      <Group />
    </div>
  );
}
...
function OurMission() {
  return (
    <div className="relative w-full flex flex-col gap-8 items-center justify-center px-4 py-8 md:px-8 lg:absolute lg:box-border lg:content-stretch lg:flex-row lg:gap-[101px] lg:left-1/2 lg:px-[80px] lg:py-0 lg:top-0 lg:translate-x-[-50%] lg:w-[1440px]" data-name="Our mission">
      <Copy />
      <div className="hidden md:block w-full md:w-[400px] lg:w-auto">
        <Vector />
      </div>
    </div>
  );
...
export default function OurMission1() {
  return (
    <div className="relative size-full" data-name="Our mission">
      <OurMission />
    </div>
  );
}